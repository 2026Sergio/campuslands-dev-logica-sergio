const calcularMetricasKickboxing = (participantes, bono, penalizacion) => {
...
console.log(calcularMetricasKickboxing([12, 18, 25, 30], 8, 3)); 

console.log("\n--- Prueba 2: Caso Borde (Colecciones vacías) ---");
console.log(calcularMetricasKickboxing([], 0, 0));

console.log("\n--- Prueba 3: Caso Propio (Efectividad en Combinaciones de Golpes Rápidos) ---");
console.log(calcularMetricasKickboxing([21, 23, 27, 25], 7, 2)); 