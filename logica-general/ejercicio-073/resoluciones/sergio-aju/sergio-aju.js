function procesarCasoParacaidismo(items, prioridad, regla) {
...
// Pruebas simples
console.log(procesarCasoParacaidismo(["aprobado", "pendiente", "bloqueado"], "alta", "revisar bloqueados primero"));
console.log(procesarCasoParacaidismo(["aprobado", "aprobado"], "alta", "revisar bloqueados primero"));