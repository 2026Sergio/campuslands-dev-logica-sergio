function procesarCasoDibujoDigital(items, prioridad, regla) {
...
// Pruebas simples
console.log(procesarCasoDibujoDigital(["aprobado", "pendiente", "bloqueado"], "alta", "revisar bloqueados primero"));
console.log(procesarCasoDibujoDigital(["aprobado", "aprobado"], "alta", "revisar bloqueados primero"));