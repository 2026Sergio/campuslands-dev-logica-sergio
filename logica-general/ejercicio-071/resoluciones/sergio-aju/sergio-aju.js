function procesarLista(items, prioridad, regla) {
...
// Pruebas simples
console.log(procesarLista(["aprobado", "pendiente", "bloqueado"], "alta", "revisar bloqueados primero"));
console.log(procesarLista(["aprobado", "aprobado"], "alta", "revisar bloqueados primero"));