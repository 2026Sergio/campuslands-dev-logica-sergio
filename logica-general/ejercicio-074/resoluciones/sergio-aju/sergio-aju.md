...
- **Entrada:** Un arreglo de cadenas de texto (`items`) relacionadas con un escenario de diagnóstico en tatuajes (ej. `"aprobado"`, `"pendiente"`, `"bloqueado"`), una cadena de `prioridad` y una descripción de la `regla`.
- **Proceso:** 
