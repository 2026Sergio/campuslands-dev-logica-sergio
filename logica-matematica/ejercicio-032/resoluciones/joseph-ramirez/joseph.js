const calcularProbabilidadPingPong = (participantes, bono, penalizacion) => {
...
console.log(calcularProbabilidadPingPong([12, 18, 25, 30], 8, 3)); 
console.log("\n--- Prueba 2: Caso Borde (Colecciones vacías) ---");
console.log(calcularProbabilidadPingPong([], 0, 0));

console.log("\n--- Prueba 3: Caso Propio (Efectividad en Puntos de Saque con Efecto) ---");
console.log(calcularProbabilidadPingPong([20, 24, 22, 26], 9, 2)); 